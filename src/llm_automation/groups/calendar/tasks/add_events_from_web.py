...
from llm_automation.dates import label, resolve_range, weekday_index
from llm_automation.groups.base import Context, Preview, PreviewOption, Row, StandardTask, TaskArgs, UserError, match_name
from llm_automation.groups.calendar.client import events_tagged, writable_calendars
from llm_automation.groups.calendar.organisers import Organiser, organiser_for, placed, save, titled
from llm_automation.groups.calendar.web_page import WebEvent, read_events

URL = re.compile(r'(?:https?://|www\.)[^\s<>"\']+', re.IGNORECASE)
DEFAULT_DURATION = timedelta(hours=2)
PAGE_TAG = 'llm_automation_page'
EVENT_TAG = 'llm_automation_key'
